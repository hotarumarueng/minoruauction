...
- [ ] 3.2 (P) ステータス更新エンドポイントを状態遷移バリデーション付きで実装する
...
- [ ] 4. プッシュ通知バックエンドの構築
- [ ] 4.1 SNS Platform Application を CDK で構成する
